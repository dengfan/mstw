...
cm.worldMessage(12, "[" + cm.getPlayer().getName() + "]成功开始挑战绯红BOSS副本，召唤出一只【猎魔人】！！");
			   cm.dispose();
		   }else{
			...
			if(cm.haveItem(4031497,1)){ //物品条件
			    ...
			    cm.spawnMobOnMap(9400591,1,1940,276,803001200);
		            //cm.summonMobter(9400633, 1);
                            //cm.summonMob(9400633,180000,5250,1);
cm.worldMessage(12, "[" + cm.getPlayer().getName() + "]成功开始挑战绯红BOSS副本，召唤出一只【血焰将军】！！");
			   cm.dispose();
		   }else{
			   cm.sendOk("需要搜集#b1个 #v4031497#");
			   cm.dispose();
			...
			if(cm.haveItem(4031497,1)){ //物品条件
			    ...
			    cm.spawnMobOnMap(9400589,1,1940,276,803001200);
		            //cm.summonMobter(9400633, 1);
                            //cm.summonMob(9400633,180000,5250,1);
cm.worldMessage(12, "[" + cm.getPlayer().getName() + "]成功开始挑战绯红BOSS副本，召唤出一只【地狱船长】！！");
			   cm.dispose();
		   }else{
			   cm.sendOk("需要搜集#b1个 #v4031497#");
			   cm.dispose();
			...
			if(cm.haveItem(4031497,1)){ //物品条件
			    ...
			    cm.spawnMobOnMap(9400590,1,1940,276,803001200);
		            //cm.summonMobter(9400633, 1);
                            //cm.summonMob(9400633,180000,5250,1);
cm.worldMessage(12, "[" + cm.getPlayer().getName() + "]成功开始挑战绯红BOSS副本，召唤出一只【海之魔女】！！");
			   cm.dispose();
		   }else{
			   cm.sendOk("需要搜集#b1个 #v4031497#");
			   cm.dispose();
