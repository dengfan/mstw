...
function action(mode, type, selection) {
	...
	if (selection == 0) {
	    item = "月石";
	    cm.sendYesNo("所以，你想要做" + item + "? 那么你需要的材料有: #b#t4011000##k, #b#t4011001##k,\r\n#b#t4011002##k, #b#t4011003##k, #b#t4011004##k, #b#t4011005##k, 和 #b#t4011006##k. 然后还有 10,000 枫币");
	} else if (selection == 1) {
	    item = "星石";
	    cm.sendYesNo("所以，你想要做" + item + "? 那么你需要的材料有: #b#t4021000##k, #b#t4021001##k, #b#t4021002##k, #b#t4021003##k, #b#t4021004##k, #b#t4021005##k, #b#t4021006##k, #b#t4021007##k 和 #b#t4021008##k. 然后还有 15,000 枫币");
	} else if (selection == 2) {
	    item = "黑羽毛";
	    cm.sendYesNo("所以，你想要做" + item + "? 那么你需要的材料有: #b1 #t4001006##k, #b1 #t4001007##k 和 #b1 #t4001008##k. 然后还有 30,000 枫币");
	}
    } else if (status == 3) {
	if (selected == 0) {
