...
public enum MapleDisease implements Serializable {
    ...
    SEDUCE(0x80),//”’ªÛ
    ZOMBIFY(0x4000),//Ω© ¨
    CONFUSE(524288L),//√‘ªÛ0x80000        
    FISHABLE(256L), //µˆ”„
    REVERSE_DIRECTION(0x80000),//∑¥∑ΩœÚ
    WEIRD_FLAME(0x8000000),//—£‘Œ
    //STUN(562949953421312L),//—£‘Œ
    STUN(0x2000000000000L),//—£‘Œ
    //POISON(1125899906842624L),//÷–∂æ
    POISON(0x4000000000000L),//÷–∂æ
    //SEAL(2251799813685248L),//∑‚”°
    SEAL(0x8000000000000L),//∑‚”°
    //DARKNESS(4503599627370496L),//∫⁄∞µ
    //WEAKEN(4611686018427387904L),//–È»ı
    DARKNESS(0x10000000000000L),//∫⁄∞µ
    WEAKEN(0x4000000000000000L),//ºı»ı
    //CURSE(0x8000000000000000L),;//◊Á÷‰
    CURSE(0x200),;// ◊Á÷‰od
