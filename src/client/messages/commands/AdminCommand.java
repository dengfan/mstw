...
public class AdminCommand {
    ...
    public static class ShutdownTime extends CommandExecute {
        ...
        public int execute(MapleClient c, String splitted[]) {
            ...
            c.getPlayer().dropMessage(6, "服务器将在" + minutesLeft + "分钟后关闭，请尽快关闭精灵商人安全下线！");
            if (ts == null && (t == null || !t.isAlive())) {
                ...
                c.getPlayer().dropMessage(6, new StringBuilder().append("服务器关闭时间修改为").append(minutesLeft).append("分钟后关闭。").toString());
            }
            return 1;
        }
    ...
    public static class GainCash extends CommandExecute {
        ...
        public int execute(MapleClient c, String splitted[]) {
            ...
            player.dropMessage("已经收到 " + amount + " 点卷");
            FileoutputUtil.logToFile("log\\给予点卷.log", "\r\n " + FileoutputUtil.NowTime() + " GM 给了 " + player.getName() + " " + amount + " 点卷。");
            return 1;
        }
...
//            }
        ...
        public String getMessage() {
            return new StringBuilder().append("!levelup - 升级").toString();
        }
    }
    ...
    public static class UnlockInv extends CommandExecute {
        ...
        public String getMessage() {
            return new StringBuilder().append("!unlockinv <全部/已装备道具/武器/消耗/设置/其他/特殊> - 解锁道具").toString();
        }
    }
    ...
    public static class 活动开始 extends CommandExecute {
        ...
        public int execute(final MapleClient c, String splitted[]) {
            if (c.getChannelServer().getEvent() == c.getPlayer().getMapId()) {
                ...
                c.getPlayer().dropMessage(5, "您必须先使用 !选择活动 设定當前频道的活动，并在当前频道活动地图里使用。");
                return 1;
            }
        }
...
//    }
    ...
    public static class SendAllNote extends CommandExecute {
        ...
        public String getMessage() {
            return new StringBuilder().append("!sendallnote <文字> 传送Note給目前频道的所有人").toString();
        }
    }
        ...
        public int execute(MapleClient c, String splitted[]) {
            ...
            for (ChannelServer cserv1 : ChannelServer.getAllInstances()) {
                for (MapleCharacter mch : cserv1.getPlayerStorage().getAllCharacters()) {
                    mch.startMapEffect("管理员发放" + gain + "经验给在线的所有玩家！祝您玩的开心玩的快乐", 5122000);
                }
            }
...
//                        }
                ...
                if (bOk) {
                    ...
                    mc.dropMessage("使用方法: !倍率设置 <exp经验|drop爆率|meso金币|bossboss爆率|pet> <类> <秒> <分> <时> 如 !倍率设置 经验 2 00 00 02");
    ...
    public static class register extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            c.getPlayer().dropMessage("[注册] 账号: " + acc + " 密码: " + password + " 注册完成。");
            return 1;
        }
    }
    ...
    public static class n extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            try {
                ...
                chr.dropMessage(6, "NPCID不正确。");
                System.out.printf("出错了，NPCID不正确！" + e.getMessage());
            }
    ...
    public static class o extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            try {
                ...
                System.out.printf("出错了，获取在线玩家信息失败。" + e.getMessage());
            }
    ...
    public static class f extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            try {
                ...
                System.out.printf("出错了，跟踪玩家出错。" + e.getMessage());
            }
