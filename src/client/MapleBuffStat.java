...
public enum MapleBuffStat implements Serializable {
    ...
    DASH(1610612736L), 
    DASH_SPEED(0x8000000000L), // 8 = 疾驰移动 
    DASH_JUMP(0x10000000000L),// 10 = 疾驰跳跃 HEX十六进制 8 + 8 = 10
    ...
    SPEED_INFUSION(0x80000000L),//极速领域 0x40000000000L   //, true     
    ...
    STANCE(0x10),
    SHARP_EYES(0x20),
    MANA_REFLECTION(0x40),//魔法反击 0x40
