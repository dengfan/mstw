...
public class LoginServer {
    ...
    public static Triple<String, String, Integer> getLoginAuth(int chrid) {
        return (Triple<String, String, Integer>) loginAuth.remove(Integer.valueOf(chrid));
    }
    ...
    public static final void run_startup_configurations() {
        userLimit = Integer.parseInt(ServerProperties.getProperty("mxmxd.UserLimit", "500"));
        ...
        try {
            ...
            System.out.println("启动 服务器: 端口 " + PORT);
        } catch (IOException e) {
