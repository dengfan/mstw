...
public class GameConstants {
    ...
    public static int getTaxAmount(final int meso) {
        if (meso >= 100000000) {
            return (int) Math.round(0.4 * meso);
        } else if (meso >= 25000000) {
            return (int) Math.round(0.3 * meso);
        } else if (meso >= 10000000) {
            return (int) Math.round(0.2 * meso);
        } else if (meso >= 5000000) {
            return (int) Math.round(0.1 * meso);
    ...
    public static int[] fishingReward = {
        ...
        5050002, 5, // 洗2转技能点卷轴
        5050001, 5, // 洗1转技能点卷轴
        4031627, 25, // White Bait (3cm)
        4031628, 6, // Sailfish (120cm)
        4031630, 25, // Carp (30cm)
        4031631, 4, // Salmon(150cm)
        4031633, 12, // Whitebait (3.6cm)
        //4031634, 1, // Whitebait (5cm)
        //4031635, 1, // Whitebait (6.5cm)
        //4031636, 1, // Whitebait (10cm)
        4031637, 12, // Carp (53cm)
        //4031638, 1, // Carp (60cm)
        //4031639, 1, // Carp (100cm)
        //4031640, 1, // Carp (113cm)
        4031641, 5, // Sailfish (128cm)
        //4031642, 1, // Sailfish (131cm)
        //4031643, 1, // Sailfish (140cm)
        //4031644, 1, // Sailfish (148cm)
        4031645, 2, // Salmon (166cm)
        //4031646, 1, // Salmon (183cm)
    ...
    */
    ...
    public static int getMountItem(final int sourceid) {
        switch (sourceid) {
            ...
            case 20011016:
            case 30001016:
                return 1932007; //怪物骑宠 鳄鱼王！
            case 1017:
            case 10001019: //骑士团白雪人
            case 1007:
            case 10001017:
            case 20001017:
            case 20011017:
