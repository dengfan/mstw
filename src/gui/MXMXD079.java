 ...
 */
public class MXMXD079 extends javax.swing.JFrame {

    private static MXMXD079 instance = new MXMXD079();

    /**
     * Creates new form MXMXD079
     */
    public static final MXMXD079 getInstance() {
        return instance;
    }
    ...
    private void initComponents() {
        ...
        chatLog.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        chatLog.setEnabled(false);
        chatLog.setMargin(new java.awt.Insets(0, 0, 0, 0));
        ...
        jTabbedPane2.addTab("启动", jPanel5);
        ...
        jTabbedPane2.addTab("保存", jPanel7);
        ...
        jTabbedPane2.addTab("重载", jPanel6);

        jButton22.setText("重置疲劳值");
        ...
        jTabbedPane2.addTab("重置", jPanel4);
        ...
        jTabbedPane2.addTab("账号", jPanel8);
        ...
        jTabbedPane2.addTab("指令", jPanel1);
        ...
        jTabbedPane2.addTab("奖励", jPanel2);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jTextField26, javax.swing.GroupLayout.DEFAULT_SIZE, 164, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabbedPane2.addTab("密码", jPanel3);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        try {
            ...
            if (!isLaunched) {
                ...
                JOptionPane.showMessageDialog(null, "[服务器] 服务器正在运行！");
            }
        } catch (InterruptedException ex) {
            Logger.getLogger(MXMXD079.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        RandomRewards.getInstance().refreshFishingRewards();
        String 输出 = "[重载数据] 钓鱼奖励重载成功。";
        //JOptionPane.showMessageDialog(null, "钓鱼奖励重载成功。");
        printChatLog(输出);
    ...
    private void sendNoticeGG() {
        try {
            ...
            for (ChannelServer cserv1 : ChannelServer.getAllInstances()) {
                for (MapleCharacter mch : cserv1.getPlayerStorage().getAllCharacters()) {
                    mch.startMapEffect(str, 5122000);
                    输出 = "[公告]:" + str;
                }
            }
            jTextField2.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MXMXD079.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
