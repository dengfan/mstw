...
//	showdown = 100;
    ...
    public final void applyStatus(final MapleCharacter from, final MonsterStatusEffect status, final boolean poison, final long duration, final boolean venom, final boolean checkboss) {
        ...
        switch (statusSkill) {
            ...
            case 4120005://- 武器用毒液 - 在飞镖上涂抹毒药攻击敌人使它一定几率中毒受持续伤害.最多可重复3次,敌人的HP不会掉落1以下.
            case 4220005://- 武器用毒液 - 在短剑上涂抹毒药攻击敌人,使它一定的几率陷入中毒状态受持续伤害.最多可重复3次,敌人的HP不会掉到1以下.
            case 14110004: {//- 武器用毒液 - [最高等级：20]\n在标枪上涂毒，进行攻击。有一定概率使敌人中毒，造成伤害。最多重复3次，敌人的HP不会掉落到1以下。
                switch (stats.getEffectiveness(Element.POISON)) {
                    case WEAK://这里应该也是免疫和增强啊。怎么是虚弱？
                        return;
                }
                break;
            }
        ...
        if (stats.isNoDoom() && stat == MonsterStatus.DOOM) {//巫毒术
            return;
        }
